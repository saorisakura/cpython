...
class FunctionSymbol(Symbol):
    def __init__(self, name: str, type: any, decl: any = None, index: int = 0, param_types: List[any] = []):
        super().__init__(name, type, index)
        self.param_types = param_types
        self.decl = decl
        self.vars = []
        self.op_stack_size = 0
        self.bytecode = []
...
class VariableSymbol(Symbol):
    def __init__(self, name: str, type: any, index: int = 0, decl: any = None):
        super().__init__(name, type, index)
        self.decl = decl
...
built_ins.add(VariableSymbol("super", None, 7))
built_ins.add(VariableSymbol("globals", None, 8))
built_ins.add(VariableSymbol("locals", None, 9))
built_ins.add(VariableSymbol("int", None, 10))
built_ins.add(VariableSymbol("float", None, 11))
built_ins.add(VariableSymbol("str", None, 12))
built_ins.add(VariableSymbol("bool", None, 13))
